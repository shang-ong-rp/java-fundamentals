...
public class SushiWorldNoPropCase {
	...
	private static void addItem() {
		...
		try {
			//File file = new File("C:\\Users\\bobo_chan\\Desktop\\sushi.txt");
			File file = new File("sushi.txt");
	...
	private static void getCheapest(ArrayList<Item> itemList) {
		...
		System.out.println(String.format("The cheapest item is the %s. It costs $%.2f", 
				cheapest.getType(), cheapest.getPrice()));
	}
